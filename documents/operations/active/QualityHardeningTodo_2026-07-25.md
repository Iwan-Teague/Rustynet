...
### QH-82 — evidence-on-pass for `--node` stages (audit item 1 of "the smallest set of changes that makes a green run mean something") is a per-stage wiring job, not a wrapper change: filed 2026-09-08 after scoping, deliberately NOT landed
