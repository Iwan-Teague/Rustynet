...
| `crates/rustynetd/src/macos_exit_nat_lifecycle.rs` | 2026-06-18 | 1 | E3,F1,F3,I1,I2,T1 | FINDINGS | RSA-0031 | fail-closed when pfctl exec fails during teardown verification (do not report forwarding_restored=true) | SecMinBar §6.D ctrl 7; CWE-636 | open |
...
| `crates/rustynetd/src/phase10.rs` | 2026-06-18 | 1 | A1,E1,E2,E4,F1,F2,F3,I2,I3,K1,T1,V1 | FINDINGS | RSA-0007 | route set_exit_node/ensure_lan_route_allowed through evaluate_with_membership; add revoked-node negative test | RSA-0007; SecMinBar §3.6/§3.8; CWE-285 | open |
