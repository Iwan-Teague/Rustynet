...
**Status:** ACTIVE — owner-executed host change (every `sudo` line is the owner's; the manager runs the verify lines). Written 2026-09-10 for the D4 decision ("cross-network on lenovo-bot/katana = restart", `ManagerHandover_2026-09-08.md` §D4) and for the two-LAN cross-network live proof the QH-83 CrossNetwork / Chaos / NegativeControl rows still owe (`QualityHardeningTodo_2026-07-25.md` QH-83).
