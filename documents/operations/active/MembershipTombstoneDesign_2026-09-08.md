...
**Status:** DESIGN ONLY — docs-only, no code changed. Follow-up to `14b174c4` ("Require the owner to mint or retire a node carrying mesh authority") and `8d82ff53` ("Compare node pubkeys case-insensitively and test the two untested arms"), whose commit message and review both name durable tombstoning as the tracked residual (`OwnerSignerSplitReview_2026-09-08.md` §1.5, findings register "Info (accepted)").
