...
§A.5 (three orchestrator stages) — `dff6fcf` code-only optional artifact validators wired into Windows security report; live artifact generation/pull still pending
