...
- Status note (2026-03-05): this document defines **Phase 10 Linux scope**. Current repository behavior now includes additional macOS dataplane hardening and CI coverage beyond Phase 10 scope. For current platform truth, see [operations/PlatformSupportMatrix.md](./operations/PlatformSupportMatrix.md) and [operations/active/CrossPlatformSecurityGapRemediationPlan_2026-03-05.md](./operations/active/CrossPlatformSecurityGapRemediationPlan_2026-03-05.md).
