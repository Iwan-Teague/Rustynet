# Antares scan — `rustynet-local-security` — CWE-78
...
**Verdict:** `aborted`  
**Budget:** 6/8 terminal cmds, 16 turns
...
$ grep -RIn "popen\(" src
$ grep -RIn "execvp" src
$ grep -RIn "popen\b" src
$ grep -RIn "unsafe exec\.|unsafe_exec\.|unsafe_spawn\.|unsafe_popen\.|unsafe_execv\.|unsafe_execvp\.|unsafe_fork\(" src
```
