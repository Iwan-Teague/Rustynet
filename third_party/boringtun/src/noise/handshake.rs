...
use chacha20poly1305::{AeadInPlace, ChaCha20Poly1305, Nonce, Tag, XChaCha20Poly1305};
use rand_core::OsRng;
...
use crate::mock_instant::Instant;
...
fn aead_chacha20_open_inner(
    ...
    let plaintext_len = inner_buffer.len() - 16;
    let (ciphertext, tag_bytes) = inner_buffer.split_at_mut(plaintext_len);
    ...
    buffer[..plaintext_len].copy_from_slice(ciphertext);
