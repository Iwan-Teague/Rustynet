...
pub fn allowlist_audit_corpus() -> Vec<AllowlistAuditCase> {
    ...
    vec![
        ...
        AllowlistAuditCase {
            label: "wg_persistent_keepalive_non_numeric_value",
            program: "wg",
            args: &[
                "set",
                "rustynet0",
        ...
        AllowlistAuditCase {
            label: "wg_unreviewed_preshared_key_tail",
            program: "wg",
            args: &[
                "set",
                "rustynet0",
        ...
        AllowlistAuditCase {
            label: "wg_set_peer_with_persistent_keepalive",
            program: "wg",
            args: &[
                "set",
                "rustynet0",
        ...
        AllowlistAuditCase {
            label: "wg_set_peer_endpoint_only_update",
            program: "wg",
            args: &[
                "set",
                "rustynet0",
