...
AUTO_TUNNEL_ENFORCE="${RUSTYNET_AUTO_TUNNEL_ENFORCE:-false}"
...
WG_ENCRYPTED_PRIVATE_KEY_PATH="${RUSTYNET_WG_ENCRYPTED_PRIVATE_KEY:-/etc/rustynet/wireguard.key.enc}"
WG_KEY_PASSPHRASE_PATH="${RUSTYNET_WG_KEY_PASSPHRASE:-/etc/rustynet/wireguard.passphrase}"
WG_PUBLIC_KEY_PATH="${RUSTYNET_WG_PUBLIC_KEY:-/etc/rustynet/wireguard.pub}"
