...
========================================
  ...
  rustynet-mcp-lab-state     — 22 tools + overnight-loop prompt. UTM discovery/
                                ...
                                get_run_result → read_report_artifact), prune_jobs,
                                run matrix. Built for unattended 24h+ loops.
