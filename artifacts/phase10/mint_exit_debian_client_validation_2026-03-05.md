...
- generated_at_utc: 2026-03-05T21:28:08Z
- commit: 94bba6f
...
| exit-assignment-refresh-rotation | PASS | generated_at advanced from 1772745842 to 1772745984 |
| client-assignment-refresh-rotation | PASS | generated_at advanced from 1772745842 to 1772745985 |

## Exit Status

```text
node_id=exit-node node_role=admin state=ExitActive generation=2 exit_node=none serving_exit_node=true lan_access=off restricted_safe_mode=false restriction_mode=None bootstrap_error=none reconcile_attempts=6 reconcile_failures=0 last_reconcile_unix=1772745855 last_reconcile_error=none encrypted_key_store=true auto_tunnel_enforce=true last_assignment=1772745842:1772745842713595038 membership_epoch=2 membership_active_nodes=2
```

## Exit Status After Assignment Refresh Window

```text
node_id=exit-node node_role=admin state=ExitActive generation=3 exit_node=none serving_exit_node=true lan_access=off restricted_safe_mode=false restriction_mode=None bootstrap_error=none reconcile_attempts=221 reconcile_failures=0 last_reconcile_unix=1772746088 last_reconcile_error=none encrypted_key_store=true auto_tunnel_enforce=true last_assignment=1772745984:1772745984439991899 membership_epoch=2 membership_active_nodes=2
```

## Client Status

```text
node_id=client-node node_role=client state=ExitActive generation=1 exit_node=exit-node serving_exit_node=false lan_access=off restricted_safe_mode=false restriction_mode=None bootstrap_error=none reconcile_attempts=4 reconcile_failures=0 last_reconcile_unix=1772745852 last_reconcile_error=none encrypted_key_store=true auto_tunnel_enforce=true last_assignment=1772745842:1772745842718594472 membership_epoch=2 membership_active_nodes=2
```

## Client Status After Assignment Refresh Window

```text
node_id=client-node node_role=client state=ExitActive generation=2 exit_node=exit-node serving_exit_node=false lan_access=off restricted_safe_mode=false restriction_mode=None bootstrap_error=none reconcile_attempts=228 reconcile_failures=0 last_reconcile_unix=1772746085 last_reconcile_error=none encrypted_key_store=true auto_tunnel_enforce=true last_assignment=1772745985:1772745985232664927 membership_epoch=2 membership_active_nodes=2
```
...
```text
interface: rustynet0
  public key: Ua2FWg9ooM3zL6QRAERt9BpH1HHfHhD1OfWhcmmf1mc=
  private key: (hidden)
  listening port: 51820

peer: Dx6mi59EMHYvSIkOcaZbKPofSBSMZvCb/qY3GveSjlw=
